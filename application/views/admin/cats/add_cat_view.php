...
<title>لوحة التحكم | اضافة تصنيف</title></head>
<body>
	...
	<div class="container">
		...
		<div class="col-3 d-none d-md-block sidebar">
			...
			<p class="top"  style="text-align:right;">اضافة تصنيف</p>
				...
				<div class="module-table-body w-100">
					<form action="<?php echo base_url() ;?>webadmin/catigory/add" method="post" enctype="multipart/form-data">
						...
						<p>
							...
							<input type="text" class="form-control input-medium" name="catigory_name" value="<?php echo set_value("catigory_name") ;?>"/><?php echo form_error("catigory_name") ;?>
						</p>
						<p>
