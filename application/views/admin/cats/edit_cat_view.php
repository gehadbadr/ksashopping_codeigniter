...
<body>
	...
	<div class="container">
		...
		<div class="col-3 d-none d-md-block sidebar">
			...
			<p class="top"  style="text-align:right;">تعديل تصنيف</p>
			<div class="module-body">																		
				<div class="module-table-body w-100">
					<form action="<?php echo base_url() ;?>webadmin/catigory/edit/<?php echo $cat[0]->cat_id ; ?>" method="post" enctype="multipart/form-data">
						...
						<p>
							...
							<input type="text" class="form-control input-medium" name="cat_name" value="<?php echo $cat[0]->name ;?>"/><?php echo form_error("cat_name") ;?>
						</p>
						<p>
							<label>الصورة الرئيسية</label>
							<input type="file"  name="photo_thumb" size="35"/><br /><br />
							<?php if(!empty($cat[0]->thumb)){?>
							<img src="<?php echo base_url().$cat[0]->thumb  ;?>" alt="" width="120" height="120" />
                            <?php }?>
						</p>
						<p>
