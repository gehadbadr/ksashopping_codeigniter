...
<body>
	...
	<div class="container">
		...
		<div class="col-md-8 col-12 mr-md-2 wrapper" >
			...
			<div class="module-body">																		
					<a class=" float-right" href="<?php echo base_url(); ?>webadmin/contact/add">
						<button class="button-item">اضافة معلومات الاتصال<img src="<?php echo base_url() ;?>images/admin/plus-small.gif" border="0" /></button>
					</a>
