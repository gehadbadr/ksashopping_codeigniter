...
<title>لوحة التحكم | اضافة صفحة</title></head>
<body>
	...
	<div class="container">
		...
		<div class="col-3 d-none d-md-block sidebar">
			...
			<p class="top"  style="text-align:right;">اضافة صفحة</p>
				...
				<div class="module-table-body w-100">
					<form action="<?php echo base_url() ;?>webadmin/pages/add" method="post" enctype="multipart/form-data">
						...
						<p>
							...
							<input type="text" class="form-control input-medium" name="page_title" value="<?php echo set_value("page_title") ;?>"/><?php echo form_error("page_title") ;?>
						</p>
						<p>
							<label>تفاصيل الصفحة</label>
							<textarea cols="80" class="editor" name="page_content" rows="10"></textarea><?php echo form_error("page_content") ;?>
...
<script>ClassicEditor
			...
			<?php }else{?>
				<br /><br /><br />
				<p style="min-height:50px;" align="center">عفوا لا يمكن اضافة اكتر من ثلاث صفحات</p>
			<?php }?>
		</div>
	</div>
