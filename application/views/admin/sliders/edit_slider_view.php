...
<body>
	...
	<div class="container">
		...
		<div class="col-3 d-none d-md-block sidebar">
			...
			<p class="top"  style="text-align:right;">تعديل شريحة</p>
			<div class="module-body">																		
				<div class="module-table-body w-100">
					<form action="<?php echo base_url() ;?>webadmin/slider/edit/<?php echo $this_slider[0]->slider_id ; ?>" method="post" enctype="multipart/form-data">
						...
						<p>
							...
							<input type="text" class="form-control input-medium" name="slider_name" value="<?php echo $this_slider[0]->slider_name ;?>"/><?php echo form_error("slider_name") ;?>
						</p>
						<p>
							<label>الرابط</label>
							<input type="text" class="form-control input-medium" name="slider_url" value="<?php echo $this_slider[0]->slider_url ;?>"/><?php echo form_error("slider_url") ;?>
						</p>
						<p>
							<label>تاريخ انتهاء العرض</label>
							<input type="date" data-date-format="dd-mm-yyyy" max="3000-12-31"   min="1000-01-01"  class="form-control input-medium" name="slider_expire" value="<?php echo $this_slider[0]->slider_expire;?>"/><?php echo form_error("slider_expire") ;?>
						</p>
						<p>
							<label>الصورة</label>
							<input type="file"  name="slider_image" size="35"/><br /><br />
							<img src="<?php echo base_url().$this_slider[0]->thumb  ;?>" alt="" width="120" height="120" />
						</p>
						<p>
