                                                                            ...
                                                                            <form action="<?php echo base_url() ;?>webadmin/video/edit/<?php echo  $this_video[0]->video_id ;?>" method="post" enctype="multipart/form-data">
                                                                                <div class="module-body">
                                                                                    <p>
                                                                                        ...
                                                                                        <input type="text" class="input-medium" name="video_name" id="username" value="<?php echo $this_video[0]->name ;?>"/>
                                                                                    </p>
                                                                                    <p>
                                                                                        <label>الرابط</label>
                                                                                        <input type="text" class="input-medium" name="video_url" id="username" value=""/></b>
                                                                                    </p>
                                                                                    <p>
                                                                                        <label>الصورة</label>
                                                                                        
                                                                                    </p>
                                                                                    <p> <img src="<?php echo $this_video[0]->image ;?>" width="100" height="100" /></p>
