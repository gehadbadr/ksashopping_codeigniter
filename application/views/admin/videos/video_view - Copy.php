                    ...
                    <table style="margin-bottom: 3px;" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
                                del=confirm('هل تريد حذف هذا الفيديو حقا؟');
                                if(del)
                                {
                                    var $t=$(this).attr('rel');
                                    ...
                                    $.post('<?php echo base_url() ;?>webadmin/video/delete/'+$t,function(data){
                                        ...
                                        {
                                            $('#myTable > tbody').html('<tr><td colspan="5" alig="center">لا يوجد فيدوهات حاليا</td></tr>');
                                        }
                                    });
                                }
                            });
                            $("#acts").live('change',function(){
                                ...
                                if(action!="-1")
                                {
                                    if($("input['name=chk[]']:checked").length==0)
                                    {
                                        ...
                                        del=confirm('هل تريد اجراء هذة العملية علي الفيدوهات المختارة');
                                        if(del)
                                        {
                                            $('#forn').submit();
                                            $(this).val('-1');
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                <div class="bottom-spacing">
                                    ...
                                    <div class="float-left">
                                        <a class="button" href="<?php echo base_url() ;?>webadmin/video/add">
                                            <span>فيديو جديد<img height="9" width="12" alt="New article" src="<?php echo base_url() ;?>images/admin/plus-small.gif"/></span>
                                        </a>
                                    </div>
                                    <div style="clear:both"></div>
                                </div>
                                <div class="module">
                                    <h2><span>الفيدوهات</span></h2>
                                        ...
                                        <form action="<?php echo base_url() ;?>webadmin/video/do_operation" id="forn" method="post">
                                            <table width="99%" class="tablesorter" id="myTable" style="background-position:center;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:5%">#</th>
                                                        <th style="width:30%">عنوان الفيديو</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    for($i=0;$i<count($videos);$i++){
                                                        ...
                                                        echo '<a href="'. base_url().'webadmin/video/edit/'.$videos[$i]->video_id.'"><img src="'. base_url().'images/admin/pencil.gif"  width="16" height="16" alt="edit" /></a>';
                                                        echo '<a href="javascript:;" class="delete" rel="'.$videos[$i]->video_id.'"><img src="'. base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
                                                        echo '</td>';
                                                        echo '</tr>';
                                                    }
                                                    }else{
