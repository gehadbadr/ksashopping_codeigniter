                                        ...
                                        <ul id="browser" class="filetree treeview-famfamfam">
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;padding-top:45px;">
                                                                        <div class="module">
                                                                            <h2><span>إضافة مستخدم</span></h2>
                                                                            <form action="<?php echo base_url() ;?>webadmin/buyers/add" method="post" enctype="multipart/form-data">
                                                                                <div class="module-body">
																				<p><b><?php echo validation_errors(); ?></b></p>
                                                                                    <p>
                                                                                        <label>اسم المستخدم</label>
                                                                                        <input type="text" class="input-medium" name="lname" id="buyername" value=""/>
                                                                                    </p>
                                                                                    <p>
                                                                                        <label>كلمة المرور</label>
                                                                                        <input type="password" class="input-medium" name="password" id="buyername" value=""/>
                                                                                    </p>
                                                                                    <p>
                                                                                        <label>إعادة كتابة كلمة المرور</label>
                                                                                        <input type="password" class="input-medium" name="repassword" id="buyername" value=""/>
                                                                                    </p>
                                                                                    <p>
                                                                                        <label>البريد الإلكترونى</label>
                                                                                        <input type="text" class="input-medium" name="email" id="buyername" value=""/>
                                                                                    </p>
                                                                                    <p>
