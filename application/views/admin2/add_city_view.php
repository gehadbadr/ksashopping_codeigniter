                    ...
                    <table dir="rtl" width="96%" align="center" border="0" cellpadding="0" cellspacing="0" height="70%">
                        <tr class="addCategory">
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                ...
                                <div class="module">
                                    <h2><span>إضافة مدينة</span></h2>

                                    <form action="<?php echo base_url(); ?>webadmin/city/add" method="post" enctype="multipart/form-data">
                                        <div class="module-body">
                                        ...
                                        <option value="">اختار الدولة</option>
                                            ...
                                            <p>
                                                <input type="submit" value="إضافة" class="submit-green"/>
                                                    <input type="button" value="إلغاء" class="submit-gray" onclick="javascript:self.location='<?php echo base_url(); ?>webadmin/city';" />
                                            </p>
