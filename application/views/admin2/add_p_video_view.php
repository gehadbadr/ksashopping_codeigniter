...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>لوحة التحكم | اضافة منتج</title>
    </head>
    <body>
                                            ...
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;padding-top:45px;">
                                                                        <div class="module">
                                                                            ...
                                                                            <form action="<?php echo base_url(); ?>webadmin/pvideo/add/<?php echo $this_product[0]->product_id ;?>" method="post" >
                                                                                <div class="module-body">
																				<p><b><?php echo validation_errors(); ?></b></p>
                                                                                  
                                                                            <p>
                                                                            <label>اضافة فيديو للمنتج</label>    
                                                                            <input type="text" name="part" value="" size="35"/>
                                                                            </p>
