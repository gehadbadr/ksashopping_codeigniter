                                            ...
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;padding-top:45px;">
                                                                        <div class="module">
                                                                            ...
                                                                            <form action="<?php echo base_url() ;?>webadmin/users/add" method="post" enctype="multipart/form-data">
                                                                                <div class="module-body">
																				<p><b><?php echo validation_errors(); ?></b></p>
                                                                                    <p>
                                                                                        <label>اسم المستخدم</label>
                                                                                        <input type="text" class="input-medium" name="username" id="username" value=""/>
                                                                                    </p>
                                                                                    <p>
                                                                                    ...
                                                                                    <p>
                                                                                        ...
                                                                                        <input type="text" class="input-medium" name="email" id="username" value=""/>
                                                                                    </p>
                                                                                    <p>
