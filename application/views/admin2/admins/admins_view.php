...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>لوحة التحكم | مدير المستخدمين</title>
                    ...
                    <table style="margin-bottom: 3px;" width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
                                ...
                                del=confirm('هل تريد حذف هذا المستخدم حقاً؟');
                            ...
                            $("#acts").live('change',function(){
...

                                {
...

                                    {
                                        ...
                                        del=confirm('هل تريد إجراء العملية على المستخدمين المختارين؟');
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="bottom-spacing">
                                                                            ...
                                                                            <div class="float-left">
                                                                                ...
                                                                                <a class="button" href="<?php echo base_url() ;?>webadmin/admins/add">

                                                                                    <span>مستخدم جديد<img height="9" width="12" alt="New article" src="<?php echo base_url() ;?>images/admin/plus-small.gif"/></span>
