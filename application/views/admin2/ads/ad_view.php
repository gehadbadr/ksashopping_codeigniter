                        ...
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
                                ...
                                if(del)
                                {
                                    ...
                                    $('tr#'+$t).html($v);
                                    $.post('<?php echo base_url() ;?>webadmin/ad/delete/'+$t,function(data){
                                        $('tr#'+$t).remove();
                                        if($('#myTable > tbody > tr').size()==0)
                                        {
                                            $('#myTable > tbody').html('<tr><td colspan="5" alig="center">لا يوجد اعلانات حالياً</td></tr>');
                                        }
                                    });
                                }
                            });
                            $("#acts").live('change',function(){
                                ...
                                if(action!="-1")
                                {
                                    if($("input['name=chk[]']:checked").length==0)
                                    {
                                        ...
                                        del=confirm('هل تريد إجراء العملية على الاعلانات المختارة؟');
                                        if(del)
                                        {
                                            $('#forn').submit();
                                            $(this).val('-1');
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                <div class="bottom-spacing">
                                    ...
                                    <div class="float-left">
                                        <a class="button" href="<?php echo base_url() ;?>webadmin/ad/add">
                                            <span>اعلان جديد <img height="9" width="12" alt="New article" src="<?php echo base_url() ;?>images/admin/plus-small.gif"/></span>
                                        </a>
                                    </div>
                                    <div style="clear:both"></div>
                                </div>
                                <div class="module">
                                    <h2><span>الاعلانات</span></h2>
                                    <div class="module-table-body">
                                        <form action="<?php echo base_url() ;?>webadmin/ad/do_operation" id="forn" method="post">
                                            <table width="99%" class="tablesorter" id="myTable" style="background-position:center;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:5%">#</th>
                                                        <th style="width:30%">عنوان الاعلان</th>
                                                        <th style="width:30%">حالة العرض</th>
                                                ...
                                                <tbody>
													...
													if(!empty($ads)){
														for($i=0;$i<count($ads);$i++){
															...
															echo '<td><a href="'. base_url().'webadmin/ad/edit/'.$ads[$i]->ad_id.'">'.$ads[$i]->ad_name.'</a></td>';
															...
															echo '<a href="'. base_url().'webadmin/ad/edit/'.$ads[$i]->ad_id.'"><img src="'. base_url().'images/admin/pencil.gif"  width="16" height="16" alt="edit" /></a>';
