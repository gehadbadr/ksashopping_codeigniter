...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
       <?php  $this->load->view('admin/includes/head.php'); ?>
        <title>لوحة التحكم | تعديل اعلان</title>
                                        ...
                                        <ul id="browser" class="filetree treeview-famfamfam">
                                            <?php $this->load->view('admin/includes/control_panel.php'); ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;padding-top:45px;">
                                                                        <div class="module">
                                                                            <h2><span>تعديل اعلان</span></h2>
                                                                            <form action="<?php echo base_url() ;?>webadmin/ad/edit/<?php echo  $this_ad[0]->ad_id ;?>" method="post" enctype="multipart/form-data">
                                                                                <div class="module-body">
                                                                                    ...
                                                                                    <p>
                                                                                        <label>الرابط</label>
                                                                                        <input type="text" class="input-medium" name="ad_url" id="username" value="<?php echo $this_ad[0]->ad_url ;?>"/></b>
                                                                                    </p>
																					<p>
                                                                                        <label>تاريخ العرض</label>
																						
																						<div id="home-date" >
																					من : <input type="text" name="ad_start" id="home-from" class="input-short" value="<?php echo $this_ad[0]->ad_start ;?>" /> إلى : <input type="text" name="ad_expire" id="home-to" class="input-short" value="<?php echo $this_ad[0]->ad_expire ;?>" />
