                        ...
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
...

                                {
                                    ...
                                    $.post('<?php echo base_url(); ?>webadmin/buyer_report/delete/'+$t,function(data){
                                            ...
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <div class="module-table-body">
                                                                                ...
                                                                                <form action="<?php echo base_url(); ?>webadmin/buyer_report/do_operation" id="forn" method="post">
                                                    ...
                                                    <?php
                                                                                    ...
                                                                                    for ($i = 0; $i < count($messages); $i++) {
                                                                                        ...
                                                                                        echo '<td><a href="'.base_url().'webadmin/buyer_report/show/'.$messages[$i]->report_id.'">' . $user[0]->username . '</a></td>';
																						$buyer = $this->buyer_model->GetbuyerByID($messages[$i]->buyer_id_fk);
                                                                                        echo '<td><a href="'.base_url().'webadmin/users/edit/'.$user[0]->user_id.'">' . $buyer[0]->fname.' '.$buyer[0]->lname . '</a></td>';
