                    ...
                    <table dir="rtl" width="96%" align="center" border="0" cellpadding="0" cellspacing="0" height="70%">
                        <tr class="addCategory">
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                ...
                                <div class="module">
                                    <h2><span>تعديل تصنيف</span></h2>
                                    <form action="<?php echo base_url(); ?>webadmin/catigory/edit/<?php echo $cat[0]->cat_id;?>" method="post" enctype="multipart/form-data">
                                        <div class="module-body">
										    ...
										    <p> <img src="<?php echo base_url() ;?><?php echo $cat[0]->thumb ;?>" width="100" height="100" /></p>
                                            ...
                                            <p>
                                                ...
                                                <input value="إلغاء" class="submit-gray" onclick="javascript:self.location='<?php echo base_url(); ?>webadmin/catigory';" type="button"/>
                                            </p>
