                                            ...
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <h2><span>التعليقات علي المنتجات </span></h2>
                                                                                    ...
                                                                                    <table width="99%" class="tablesorter" id="myTable" style="background-position:center;">
                                                                                        ...
                                                                                        <thead>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <th style="width:30%">اسم المعلق</th>
                                                    ...
                                                    <?php
                                                                                    ...
                                                                                    for ($i = 0; $i < count($messages); $i++) {
                                                                                        ...
                                                                                        echo '<tr id="' . $messages[$i]->comment_id . '">';

                                                                                        echo '<td class="align-center">' . $messages[$i]->comment_id . '</td>';

                                                                                        echo '<td><a href="'.base_url().'webadmin/comment/show/'.$messages[$i]->comment_id.'">' . $messages[$i]->name . '</a></td>';
                                                                                        $product  = $this->products_model->GetProductByID($messages[$i]->product_id_fk);
                                                                                        echo '<td><a href="'.base_url().'webadmin/product/edit/'.$product[0]-> product_id.'">' . $product[0]->name . '</a></td>';
																						
																						echo '<td><input type="checkbox" name="chk[]" value="' . $messages[$i]->comment_id . '" />';

                                                                                        echo '<a href="javascript:;" class="delete" rel="' . $messages[$i]->comment_id . '"><img src="'. base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
