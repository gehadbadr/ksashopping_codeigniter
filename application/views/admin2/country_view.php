                        ...
                        $("#acts").live('change',function(){
                            ...
                            if(action!="-1")
                            {
                                if($("input['name=chk[]']:checked").length==0)
                                {
                                    ...
                                    del=confirm('هل تريد إجراء العملية على الدول المختارة');
                                    if(del)
                                    {
                                        $('#forn').submit();
                                        $(this).val('-1');
                                            ...
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="bottom-spacing">
                                                                            ...
                                                                            <div class="float-left">
                                                                                ...
                                                                                <a class="button" href="<?php echo base_url(); ?>webadmin/country/add/">
                                                                                    <span>دولة جديد <img height="9" width="12" alt="New article" src="<?php echo base_url(); ?>images/admin/plus-small.gif"/></span>
                                                                                </a>
                                                                            </div>
                                                                        ...
                                                                        <div class="module">
                                                                            <h2><span>الدول</span></h2>
                                                                            <div class="module-table-body">
                                                                                <form action="<?php echo base_url(); ?>webadmin/country/do_operation" id="forn" method="post" >
                                                                                    <table width="99%" class="tablesorter" id="myTable" style="background-position:center;">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th style="width:5%">#</th>
                                                                                                <th style="width:30%">اسم الدولة</th>
                                                    ...
                                                    <?php 
                                                                                    ...
                                                                                    for ($i = 0; $i < count($cats); $i++) {
                                                                                        echo '<tr id="' . $cats[$i]->country_id . '">';
                                                                                        echo '<td class="align-center">' . $cats[$i]->country_id . '</td>';
																						echo '<td><a href="' . base_url() . 'webadmin/country/edit/' . $cats[$i]->country_id . '">' . $cats[$i]->name . '</a></td>';
                                                                                        echo '<td>';
                                                                                        echo '<input type="checkbox" name="chk[]" value="' .$cats[$i]->country_id . '" />';
                                                                                        echo '<a href="' . base_url() . 'webadmin/country/edit/' . $cats[$i]->country_id . '" title="تعديل"><img src="' . base_url() . 'images/admin/pencil.gif"  width="16" height="16" alt="edit" /></a>';
                                                                                        echo '<a href="javascript:;" class="delete" title="حذف" rel="' . $cats[$i]->country_id . '">';
