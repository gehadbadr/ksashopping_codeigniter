                    ...
                    <table dir="rtl" width="96%" align="center" border="0" cellpadding="0" cellspacing="0" height="70%">
                        <tr class="addCategory">
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                ...
                                <div class="module">
                                    <h2><span>تعديل المدينة</span></h2>
                                    <form action="<?php echo base_url(); ?>webadmin/city/edit/<?php echo $cat[0]->city_id;?>" method="post" enctype="multipart/form-data">
                                        <div class="module-body">
                                        ...
                                        <option value="">اختار الدولة</option>
                                                    <?php
                                                              for ($i = 0; $i < count($country); $i++) {
                                                                if ($cat[0]->country_id_fk == $country[$i]->country_id) {
                                                                 echo "<option value='" . $country[$i]->country_id . "' selected=''>" . $country[$i]->name . "</option>";
                                                                } else {
                                                                   echo "<option value='" . $country[$i]->country_id . "'>" . $country[$i]->name . "</option>";
                                                             }
                                                         }
                                                    ?>
                                          </select>
                                            ...
                                            <p>
                                                ...
                                                <input class="input-medium" name="cat_name" id="username" value="<?php echo $cat[0]->name;?>" type="text"/>
                                            </p>
										
                                            <p>
                                                <input value="تعديل" class="submit-green" type="submit"/>
                                                <input value="إلغاء" class="submit-gray" onclick="javascript:self.location='<?php echo base_url(); ?>webadmin/city';" type="button"/>
                                            </p>
