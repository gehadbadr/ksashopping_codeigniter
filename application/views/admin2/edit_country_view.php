...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>لوحة التحكم | الدولة</title>
    </head>
                    ...
                    <table dir="rtl" width="96%" align="center" border="0" cellpadding="0" cellspacing="0" height="70%">
                        <tr class="addCategory">
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                ...
                                <div class="module">
                                    <h2><span>تعديل الدولة</span></h2>
                                    <form action="<?php echo base_url(); ?>webadmin/country/edit/<?php echo $cat[0]->country_id;?>" method="post" enctype="multipart/form-data">
                                        <div class="module-body">
										...
										<?php }?>
                                            ...
                                            <p>
                                                ...
                                                <input value="إلغاء" class="submit-gray" onclick="javascript:self.location='<?php echo base_url(); ?>webadmin/country';" type="button"/>
                                            </p>
