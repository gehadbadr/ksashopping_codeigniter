                                        ...
                                        <ul id="browser" class="filetree treeview-famfamfam">
                                            <?php $this->load->view('admin/includes/control_panel.php'); ?>
                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <!-- Button -->
                                                                        <div class="module">
                                                                            <h2><span>صفحات التواصل الاجتماعي</span></h2>
                                                                            <div class="module-table-body">
                                                                               
                                                                                <div class="float-right">
                                                                                    <a class="button" href="<?php echo base_url(); ?>webadmin/facebook/add">
                                                                                        <span>تعديل الصفحات<img height="9" width="12" alt="New article" src="<?php echo base_url() ;?>images/admin/plus-small.gif"/></span>
                                            </a>
                                        </div>
