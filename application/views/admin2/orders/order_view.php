                                            ...
                                            <?php $this->load->view('admin/includes/control_panel.php'); ?>
                                                    ...
                                                    <?php
                                                                                    ...
                                                                                    for ($i = 0; $i < count($orders); $i++) {
                                                                                        ...
                                                                                        echo '<tr id="' . $orders[$i]->order_id  . '">';

                                                                                        echo '<td class="align-center">' . $orders[$i]->order_id  . '</td>';
                                                                                        echo '<td><a href="'.base_url().'webadmin/order/edit/'.$orders[$i]->order_id .'">' . $orders[$i]->name. '</a></td>';
																						
																						echo '<td><a href="'.base_url().'webadmin/order/edit/'.$orders[$i]->order_id .'">' . $orders[$i]->email . '</a></td>';

                                                                                        echo '<td><input type="checkbox" name="chk[]" value="' . $orders[$i]->order_id  . '" />';

                                                                                        echo '<a href="javascript:;" class="delete" rel="' . $orders[$i]->order_id  . '"><img src="'. base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
