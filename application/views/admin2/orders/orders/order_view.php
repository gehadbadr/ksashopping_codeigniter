                    ...
                    <table style="margin-bottom: 3px;" width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
                                ...
                                del=confirm('هل تريد حقا حذف هذا الطلب');
...

                                {
                                    ...
                                    $.post('<?php echo base_url(); ?>webadmin/order/delete/'+$t,function(data){
...

                                        {
                                            ...
                                            $('#myTable > tbody').html('<tr><td colspan="5" alig="center">لا يوجد أى طلب شراء</td></tr>');
                                            ...
                                            <?php $this->load->view('admin/includes/control_panel.php'); ?>
                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <h2><span>الطلبات</span></h2>



                                                                            <div class="module-table-body">

                                                                                <form action="<?php echo base_url(); ?>webadmin/order/do_operation" id="forn" method="post">
                                                    ...
                                                    <?php
                                                                                    ...
                                                                                    for ($i = 0; $i < count($messages); $i++) {
                                                                                        ...
                                                                                        echo '<tr id="' . $messages[$i]->order_id  . '">';

                                                                                        echo '<td class="align-center">' . $messages[$i]->order_id  . '</td>';
																						$data["buyer"] = $this->buyer_model->GetbuyerByID($messages[$i]->buyer_id_fk);
                                                                                        echo '<td><a href="'.base_url().'webadmin/order/edit/'.$messages[$i]->order_id .'">' . $data["buyer"][0]->fname .' '.$data["buyer"][0]->lname . '</a></td>';
																						
																						echo '<td><a href="'.base_url().'webadmin/order/edit/'.$messages[$i]->order_id .'">' . $data["buyer"][0]->email . '</a></td>';

                                                                                        echo '<td><input type="checkbox" name="chk[]" value="' . $messages[$i]->order_id  . '" />';

                                                                                        echo '<a href="javascript:;" class="delete" rel="' . $messages[$i]->order_id  . '"><img src="'. base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
