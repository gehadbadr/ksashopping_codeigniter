...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
       <?php  $this->load->view('admin/includes/head.php'); ?>
        ...
        <title>لوحة النحكم | تعديل صفحة</title>
    </head>
    <body>
                        ...
                        <tr class="addCategory">
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;padding-top:45px;">
                                <div class="module"><?php
                                           ...
                                           ?>
                                    <h2><span>تعديل صفحة</span></h2>
                                    <form action="<?php echo base_url(); ?>webadmin/pages/edit/<?php echo $row->page_id ; ?>" method="post" enctype="multipart/form-data">
                                       
                                       <div class="module-body">
									   
                                            <p>
                                                <label>عنوان الصفحة</label>
                                                <input type="text" class="input-medium" name="page_title" id="username" value="<?php echo $row->title ; ?>"/>
                                            </p>
                                            <p>
                                                <label>محتوي الصفحة</label>
                                                <textarea id="editor1" name="page_content" rows="8" cols="60"><?php echo $row->content ; ?></textarea>
                                                <script type="text/javascript">
                                                                                    //<![CDATA[
											...
											<p> <img src="<?php echo base_url() ;?><?php echo $row->thumb ;?>" width="100" height="100" /></p>
                                            <?php }?>                                        
                                            <p><?php
	                                                endforeach;
