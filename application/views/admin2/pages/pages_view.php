                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                                                        <div class="bottom-spacing">
                                                                            ...
                                                                            <div class="float-left">
																				...
																				<a class="button" href="<?php echo base_url(); ?>webadmin/pages/add/">
                                                                                    <span>صفحة جديدة<img height="9" width="12" alt="New article" src="<?php echo base_url(); ?>images/admin/plus-small.gif"/></span>
                                                                                </a>
																				<?php }else{?>
                                                                        ...
                                                                        <div class="module">
                                                                            <h2><span>الصفحات الداخلية</span></h2>
