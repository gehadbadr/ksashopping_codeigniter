...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>لوحة التحكم |رسائل تاكيد الدفع</title>
                        ...
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
...

                                {
                                    ...
                                    $.post('<?php echo base_url(); ?>webadmin/pay_confirm/delete/'+$t,function(data){
										        ...
										        <?php  $this->load->view('admin/includes/control_panel.php'); ?>
                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <h2><span>صندوق رسائل تاكيد الطلبات</span></h2>



                                                                            <div class="module-table-body">

                                                                                <form action="<?php echo base_url(); ?>webadmin/pay_confirm/do_operation" id="forn" method="post">
                                                    ...
                                                    <?php
                                                                                    ...
                                                                                    for ($i = 0; $i < count($messages); $i++) {
                                                                                        ...
                                                                                        echo '<tr id="' . $messages[$i]->pay_confirm_id . '">';

                                                                                        echo '<td class="align-center">' . $messages[$i]->pay_confirm_id . '</td>';

                                                                                        echo '<td><a href="'.base_url().'webadmin/pay_confirm/show/'.$messages[$i]->pay_confirm_id.'">' . $messages[$i]->name . '</a></td>';

                                                                                        echo '<td><input type="checkbox" name="chk[]" value="' . $messages[$i]->pay_confirm_id . '" />';

                                                                                        echo '<a href="javascript:;" class="delete" rel="' . $messages[$i]->pay_confirm_id . '"><img src="'. base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
