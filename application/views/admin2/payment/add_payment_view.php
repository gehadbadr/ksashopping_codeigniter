                    ...
                    <table dir="rtl" width="96%" align="center" border="0" cellpadding="0" cellspacing="0" height="70%">
                        <tr class="addCategory">
                            ...
                            <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                ...
                                <div class="module">
                                    <h2><span>اضافة طريقة للدفع</span></h2>
                                    ...
                                    <form action="<?php echo base_url(); ?>webadmin/payment/add" method="post" enctype="multipart/form-data">
                                        <div class="module-body">
                                            ...
                                            <p>
                                                ...
                                                <input type="text" class="input-medium" name="payment_name" id="username" value=""/>
                                            </p>
											<p>
                                                <label>تفاصيل طريقة الدفع</label>
                                                <textarea id="editor1" name="content" rows="8" cols="60"></textarea>
                                                <script type="text/javascript">
                                                                                    //<![CDATA[
