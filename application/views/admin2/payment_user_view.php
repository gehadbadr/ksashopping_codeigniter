                                        ...
                                        <ul id="browser" class="filetree treeview-famfamfam">
                                            <?php include 'includes/control_panel.php'; ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            <h2><span>طرق الدفع الخاصة بالعميل <?php echo $this_user[0]->username;?></span></h2>
                                                    ...
                                                    <?php                           if(!empty($cats)){
																						for ($i = 0; $i < count($cats); $i++) {
																							...
																							echo '<td><a href="' . base_url() . 'webadmin/payment/edit/' . $cats[$i]->cat_id . '">' . $cats[$i]->name . '</a></td>';
																							echo '<td>';
																							echo '<input type="checkbox" name="chk[]" value="' . $cats[$i]->cat_id . '" />';
																							echo '<a href="' . base_url() . 'webadmin/payment/edit/' . $cats[$i]->cat_id . '" title="تعديل"><img src="' . base_url() . 'images/admin/pencil.gif"  width="16" height="16" alt="edit" /></a>';
																						...
																						echo '<td><strong>لا يوجد طرق للدفع</strong></td>';
																						echo '<td>';
																						echo '</td>';
																						echo '</tr>';}
                                                    ?>
