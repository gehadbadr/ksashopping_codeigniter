            ...
            <tr>
                <td><table style="margin-bottom: 3px;" width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<script type="text/javascript">
							...
							var row = $(this).parents("tr:first");
							var $t=$(this).attr('rel');
							$.post('<?php echo base_url(); ?>webadmin/cat/sort_up/'+$t,function(data){
                               });
							...
							var row = $(this).parents("tr:first");
							var $t=$(this).attr('rel');
							$.post('<?php echo base_url(); ?>webadmin/cat/sort_down/'+$t,function(data){
                               });
...
<!--                                            <div class="pagination">
										...
										<br />
										<form action="<?php echo base_url(); ?>webadmin/cat/sort" id="form" method="post">
											...
											<form action="<?php echo  base_url(); ?>webadmin/cat/path" id="path" method="post">
                                            <?php if(!empty($cat_id)){
									  echo'
                                             										
											
											 <input type="hidden" class="er" name="codet" value="' .$cat_id.'" />';}?>											
