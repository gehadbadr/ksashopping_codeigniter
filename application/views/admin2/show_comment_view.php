                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <div class="module-table-body">
                                                                                <form action="<?php echo base_url(); ?>webadmin/comment/update/<?php echo $this_message[0]->comment_id; ?>" id="forn" method="post">
		                                                                    <!--<p>
                                                                             <label>عرض التعليق</label>
                                                                            <?php  if ($this_message[0]->statue=='on'){?>
                                                                            ...
                                                                            <?php }else{ echo '<input type="checkbox" name="statue" />';}?>
																				   ...
																				   <table width="99%" class="tablesorter" id="myTable" style="background-position:center;">
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr style="width:70%">
                                                                                                <td>التعليق:</td><td><?php echo $this->admin_model->bb2html($this_message[0]->comment) ;?></td>
                                                                                            </tr>
