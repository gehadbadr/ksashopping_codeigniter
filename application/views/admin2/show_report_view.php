                                                                    ...
                                                                    <td width="75%" valign="top"  style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <div class="module-table-body">
                                                                                <form action="<?php echo base_url(); ?>webadmin/report/update/<?php echo $this_message[0]->report_id; ?>" id="forn" method="post">
		                                                                   <?php $buyer = $this->buyer_model->GetbuyerByID($this_message[0]->buyer_id_fk);?>                                                                           
																				   <table width="99%" class="tablesorter" id="myTable" style="background-position:center;">
                                                                                        <tbody>
                                                                                            <tr style="width:30%">
                                                                                                <td>الاسم:</td><td><?php echo $buyer[0]->fname.' '.$buyer[0]->lname; ?></td>
                                                                                            </tr>
																							<tr style="width:30%">
                                                                                                <td>الايميل:</td><td><?php echo $buyer[0]->email; ?></td>
                                                                                            </tr>
																							<?php $user  = $this->user_model->GetuserByID($this_message[0]->user_id_fk);?>
																							<tr style="width:30%">
                                                                                                <td>المبلغ عنه:</td><td><?php echo '<a href="'.base_url().'webadmin/users/edit/'.$user[0]->user_id.'">' . $user[0]->username . '</a>'; ?></td>
                                                                                            </tr>
                                                                                            <tr style="width:70%">
                                                                                    ...
                                                                                    <div class="table-apply">
																						...
																						<!--<input type="submit" value="تعديل" class="submit-green"/>--> 
                                                                                            <input type="button" value="رجوع" class="submit-gray" onclick="javascript:self.location='<?php echo base_url(); ?>webadmin/report';" />
                                                </p>
                                            </div>
                                        </form>
