...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
       <?php  $this->load->view('admin/includes/head.php'); ?>
        <title>لوحة التحكم | اضافة شريحة</title>
                                        ...
                                        <ul id="browser" class="filetree treeview-famfamfam">
                                            <?php $this->load->view('admin/includes/control_panel.php'); ?>
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;padding-top:45px;">
                                                                        <div class="module">
                                                                            <h2><span>اضافة شريحة</span></h2>
                                                                            <form action="<?php echo base_url() ;?>webadmin/slider/add/" method="post" enctype="multipart/form-data">
                                                                                <div class="module-body">
																				
                                                                                    <p>
                                                                                        <label>عنوان الشريحة</label>
                                                                                        <input type="text" class="input-medium" name="slider_name" id="username" value="<?php echo set_value("slider_name") ;?>"/>
                                                                                    </p>
                                                                                    <p>
                                                                                        <label>الرابط</label>
                                                                                        <input type="text" class="input-medium" name="slider_url" id="username" value="<?php echo set_value("slider_url") ;?>"/><b dir="ltr"></b>
                                                                                    </p>
																					<p>
                                                                                        <label>تاريخ انتهاء العرض</label>
																						
																						<div id="home-date" >
																				     إلى : <input type="text" name="slider_expire" id="home-to" class="input-short" value="<?php echo set_value("slider_expire") ;?>" />
