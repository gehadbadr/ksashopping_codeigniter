...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>لوحة التحكم | البائعون</title>
                        ...
                        <tbody>
                            ...
                            $(".delete").live('click',function(){
...

                                {
                                    ...
                                    $.post('<?php echo base_url() ;?>webadmin/users/delete/'+$t,function(data){
							...
							var $t=$(this).attr('rel');
							$.post('<?php echo base_url(); ?>webadmin/users/block/'+$t,function(data){
                               });
							...
							var $t=$(this).attr('rel');
							$.post('<?php echo base_url(); ?>webadmin/confirm_user/confirm/'+$t,function(data){
                               });
                                                                    ...
                                                                    <td width="75%" valign="top" align="right" style="padding-right: 5px;">
                                                                        ...
                                                                        <div class="bottom-spacing">
                                                                            ...
                                                                            <div class="float-left" style="min-height:25px;">
                                                                               ...
                                                                               <!--   <a class="button" href="<?php echo base_url() ;?>webadmin/users/add">
                                                                        ...
                                                                        <div class="module">
                                                                            ...
                                                                            <h2><span>البائعون</span></h2>

                                                                            <div class="module-table-body">

                                                                                <form action="<?php echo base_url() ;?>webadmin/<?php if(!empty($users)){ echo 'users';}else { echo 'confirm_user';}?>/do_operation" id="forn" method="post">
                                                    ...
                                                    <?php
                                                                                if(!empty($users)){
                                                                                    for ($i = 0; $i < count($users); $i++) {
                                                                                        ...
                                                                                        echo '<tr id="' . $users[$i]->user_id . '">';

                                                                                        echo '<td class="align-center">' . $users[$i]->user_id . '</td>';

                                                                                        echo '<td><a href="' . base_url() . 'webadmin/users/edit/' . $users[$i]->user_id . '">' . $users[$i]->username . '</a></td>';

                                                                                        echo '<td>';

																						if($users[$i]->authority == 0){
																						$text='موقوف';
																						}elseif($users[$i]->authority == 1){
																						$text='عادية';
																						}elseif($users[$i]->authority == 2){
																						$text='ذهبية';
																						}
                                                                                        
                                                                                        echo '<a href="'.base_url().'webadmin/users/edit/'.$users[$i]->user_id.'">' . $text . '</a></td>';
																						
																						echo '<td><input type="checkbox" name="chk[]" value="' . $users[$i]->user_id  . '" />';
                                                                                        
																						echo '<a href="' . base_url() . 'webadmin/users/edit/' . $users[$i]->user_id . '"><img src="' . base_url() . 'images/admin/pencil.gif"  width="16" height="16" alt="edit" /></a>';
																	                   ...
																	                   echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
																						...
																						echo '&nbsp;<a href="javascript:;" class="block" rel="' . $users[$i]->user_id . '"><img src="' . base_url() . 'images/admin/notification-slash.gif"  width="16" height="16" alt="block" /></a>';
 
                                                                                        }

                                                                                        echo '&nbsp;<a href="javascript:;" class="delete" rel="' . $users[$i]->user_id . '"><img src="'.base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
																				...
																				if(!empty($confirm_user)){
                                                                                    for ($i = 0; $i < count($confirm_user); $i++) {

                                                                                        echo '<tr id="' . $confirm_user[$i]->user_id . '">';

                                                                                        echo '<td class="align-center">' . $confirm_user[$i]->user_id . '</td>';

                                                                                        echo '<td><a href="' . base_url() . 'webadmin/users/edit/' . $confirm_user[$i]->user_id . '">' . $confirm_user[$i]->username . '</a></td>';

                                                                                       																
																						echo '<td><input type="checkbox" name="chk[]" value="' . $confirm_user[$i]->user_id  . '" />';
                                                                                        
																						echo '<a href="' . base_url() . 'webadmin/users/edit/' . $confirm_user[$i]->user_id . '"><img src="' . base_url() . 'images/admin/pencil.gif"  width="16" height="16" alt="edit" /></a>';
                                                                                       
																					  
																						echo '&nbsp;<a href="javascript:;" class="confirm" rel="' . $confirm_user[$i]->user_id . '"><img src="' . base_url() . 'images/admin/tick-circle.gif"  width="16" height="16" alt="confirm" /></a>';
 

                                                                                        echo '&nbsp;<a href="javascript:;" class="delete" rel="' . $confirm_user[$i]->user_id . '"><img src="'.base_url().'images/admin/cross-on-white.gif"  width="16" height="16" alt="comments" /></a>';
